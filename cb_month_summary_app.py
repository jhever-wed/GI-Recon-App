...
if atlantis_file and gmi_file:
    st.info('📥 Both files received, proceeding to load.')
    ...
    st.info('🔍 Filtered Atlantis to TP records.')
    ...
    st.info('🔗 Merging both summaries...')
